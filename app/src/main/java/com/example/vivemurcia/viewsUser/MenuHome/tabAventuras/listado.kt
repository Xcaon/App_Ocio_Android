package com.example.vivemurcia.viewsUser.MenuHome.tabAventuras
...
fun ListadoAventuras(navController: NavController) {
    ...
    val actividades: List<Actividad> by homeViewModel.actividadesPorCategoria[EnumCategories.AVENTURAS]!!.collectAsState()
